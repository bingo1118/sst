...
//			    	radapter.loadData();
				...
				P2PHandler.getInstance().openAudioAndStartPlaying(contact.contactType);
	...
	public void searchByTime(int time) {
		...
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");
			...
			Log.e("currenttime", endTime);
				...
				if(minute<=9){
					starttime=year+"-"+month+"-"+day+" "+hour+":"+"0"+minute;
				}else{
			...
			Log.e("currenttime",year+"-"+month+"-"+day+" "+hour+":"+minute);
	}
